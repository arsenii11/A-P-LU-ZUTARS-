...
#Checking that denomitators are not zero
if d1 != 0 and d2 != 0:
    n, d = summarize(n1, d1, n2, d2)
    n, d = simplify(n, d)

result = n #Value for the result of programm

#In case of inequality of nominator and denominator make a formating output value
if n != d and n != -d:
